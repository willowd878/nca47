...
class DBCommon(object):
    ...
    def get_vres_agent_view_for_fw(self, context, **kwargs):
        vres_agent_view = {
            "tenant_id": kwargs['tenant_id'],
            "network_zone": kwargs['network_zone'],
            "dc_name": kwargs['dc_name']
        ...
        vres = objects.Vres_Agent_View(context, **vres_agent_view)
        return vres.get_objects(context, **vres_agent_view)

    def get_vres_agent_vfw_view(self, context, **kwargs):
        view = {
            "tenant_id": kwargs['tenant_id'],
            "network_zone": kwargs['network_zone'],
            "dc_name": kwargs['dc_name']
        }
        vres = objects.Vres_Agent_Vfw_View(context, **view)
        return vres.get_objects(context, **view)
