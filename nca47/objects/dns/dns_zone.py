...
class DnsZone(base.Nca47Object):
    ...
    def get_all_objects(self, context, values):
        zone = self.db_api.get_all_objects(ZoneModel, values)
        return zone

    def get_all_objects_by_conditions(self, context, lik_dic, search_dic):
        zone = self.db_api.get_all_objects_by_conditions(ZoneModel, lik_dic,
                                                         search_dic)
        return zone
